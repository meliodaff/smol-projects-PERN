...
function Header({ userInput, setCertainMovie }) {
  // i think this should be setUserInput just for clarification sakeW
  ...
  function handleChange(event) {
    ...
    setCertainMovie(event.target.value);
  }
  return (
